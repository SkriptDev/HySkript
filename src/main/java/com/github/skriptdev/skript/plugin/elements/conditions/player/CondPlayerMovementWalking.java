...
public class CondPlayerMovementWalking extends PropertyConditional<Player> {

    public static void register(SkriptRegistration reg) {
        reg.newPropertyConditional(CondPlayerMovementWalking.class,
                "players", ConditionalType.BE, "walking")
            .name("Player Movement - Walking")
    ...
    public boolean check(@NotNull TriggerContext ctx) {
        return this.getPerformer().check(ctx, player -> {
            ...
            return component.getMovementStates().walking;
        }, isNegated());
    }
